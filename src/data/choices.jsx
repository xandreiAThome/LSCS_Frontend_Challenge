export default [
  ...
  [
    ...
    "c. A function that describes the speed of a particle.",
  ],
  [
    "a. It states that the position and momentum of a particle cannot both be precisely determined at the same time.",
    "b. It states that energy and time cannot both be precisely determined at the same time.",
